...
public class Page {
    ...
    private List<ResultItems> resultItemList = new ArrayList<ResultItems>();
    

    public List<ResultItems> getResultItemList() {
		return resultItemList;
	}

	public void setResultItemList(List<ResultItems> resultItemList) {
		this.resultItemList = resultItemList;
	}
	public  void putItems(ResultItems resultItems)
	{
		this.resultItemList.add(resultItems);
	}
    ...
    public void setRequest(Request request) {
        ...
        {
        	resultItemList.get(i).setRequest(request);
        }
    }
