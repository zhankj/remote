...
<title>Uikit Test</title>
    ...
    <link rel="stylesheet" type="text/css" href="http://apps.bdimg.com/libs/uikit/2.8.0/css/uikit.gradient.min.css">
...
<script type="text/javascript" src="http://apps.bdimg.com/libs/uikit/2.8.0/js/uikit.min.js"></script>
<script type="text/javascript" src="http://apps.bdimg.com/libs/uikit/2.8.0/js/addons/notify.min.js"></script>
